...
<head>
    ...
    <title>500 — Erreur serveur · UpcycleConnect</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-family: 'Bebas Neue', sans-serif; font-size: 7rem; margin: 0; color: var(--coffee); line-height: 1; border-bottom: 3px solid var(--coffee); padding-bottom: 20px; margin-bottom: 20px; }
...
<body>
    ...
    <main>
        <div class="box">
            <span class="badge">Erreur 500</span>
            <h1>500</h1>
            <h2>Erreur serveur</h2>
            <p>Une erreur inattendue s'est produite côté serveur.<br>
               Nos équipes en ont été notifiées. Réessayez dans quelques instants.</p>
            <div class="actions">
