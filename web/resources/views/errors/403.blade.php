...
<head>
    ...
    <title>403 — Accès interdit · UpcycleConnect</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-family: 'Bebas Neue', sans-serif; font-size: 7rem; margin: 0 0 4px; color: var(--cherry); line-height: 1; border-bottom: 3px solid var(--coffee); padding-bottom: 20px; margin-bottom: 20px; }
    ...
    <main>
        <div class="box">
            ...
            <p>Vous n'avez pas les droits nécessaires pour accéder à cette page.<br>
               Si vous pensez que c'est une erreur, contactez l'administrateur.</p>
            <div class="actions">
