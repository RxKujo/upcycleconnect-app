...
<head>
    ...
    <title>419 — Session expirée · UpcycleConnect</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { font-family: 'Bebas Neue', sans-serif; font-size: 7rem; margin: 0; color: var(--forest); line-height: 1; border-bottom: 3px solid var(--coffee); padding-bottom: 20px; margin-bottom: 20px; }
...
<body>
    ...
    <main>
        <div class="box">
            <span class="badge">Erreur 419</span>
            <h1>419</h1>
            <h2>Session expirée</h2>
            <p>Votre session a expiré ou le jeton de sécurité est invalide.<br>
               Rechargez la page et réessayez.</p>
            <div class="actions">
                <a href="javascript:location.reload()" class="btn btn-secondary">↺ Recharger</a>
