...
<div class="main-content">
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:32px;">
        <div>
            <h1 class="font-bebas" style="font-size:2.4rem;">Dashboard Expert Pro</h1>
            <p class="font-mono" style="font-size:0.8rem; color:#666;">Année {{ $annee }}</p>
        </div>
        <div style="display:flex; gap:12px;">
            <a href="{{ route('pro.dashboard.essential') }}" class="btn-secondary btn-sm">Vue mensuelle</a>
            <a href="{{ route('pro.dashboard.export-pdf') }}" class="btn-primary btn-sm">Exporter PDF</a>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:24px;">
            <div style="border:3px solid #120309; padding:24px; text-align:center;">
                ...
                <div class="font-mono" style="font-size:0.7rem;">Objets récupérés</div>
            </div>
            <div style="border:3px solid #120309; padding:24px; text-align:center;">
                ...
                <div class="font-mono" style="font-size:0.7rem;">Déchets évités</div>
            </div>
            <div style="border:3px solid #120309; padding:24px; text-align:center;">
                ...
                <div class="font-mono" style="font-size:0.7rem;">CO₂ évité</div>
            </div>
        </div>
    </div>
    ...
    {{-- Badges --}}
    <div class="card">
        <h2 class="font-bebas" style="font-size:1.6rem; margin-bottom:24px;">Vos badges</h2>
        @if(empty($badges))
            <p style="color:#666; font-style:italic;">Aucun badge obtenu pour le moment. Continuez à récupérer des objets !</p>
        @else
        ...
        <div style="margin-top:24px;">
            <form method="POST" action="{{ route('pro.badges.recalculer') }}">
                @csrf
                <button type="submit" class="btn-secondary btn-sm">Recalculer mes badges</button>
            </form>
        </div>
    </div>
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:16px;">
        <a href="{{ route('pro.alertes.index') }}" class="btn-secondary" style="text-align:center;">Alertes matériaux</a>
