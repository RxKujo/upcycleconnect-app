...
<div class="page-container" style="max-width:800px;">
    ...
    <p class="font-mono" style="font-size:0.75rem; opacity:0.5; margin-bottom:40px;" data-i18n="rgpd.updated">Conformément au RGPD — Dernière mise à jour : avril 2026</p>

    <div style="font-size:0.95rem; line-height:1.8;">
        <h2 style="font-family:'Bebas Neue',sans-serif; font-size:1.8rem; margin:32px 0 12px;" data-i18n="rgpd.h1">1. Données collectées</h2>
        ...
        <h2 style="font-family:'Bebas Neue',sans-serif; font-size:1.8rem; margin:32px 0 12px;" data-i18n="rgpd.h2">2. Finalité du traitement</h2>
        ...
        <h2 style="font-family:'Bebas Neue',sans-serif; font-size:1.8rem; margin:32px 0 12px;" data-i18n="rgpd.h3">3. Anonymisation publique</h2>
        ...
        <h2 style="font-family:'Bebas Neue',sans-serif; font-size:1.8rem; margin:32px 0 12px;" data-i18n="rgpd.h4">4. Durée de conservation</h2>
        <p>Les données sont conservées pendant la durée de votre compte, plus 3 ans après suppression pour obligations légales.</p>

        <h2 style="font-family:'Bebas Neue',sans-serif; font-size:1.8rem; margin:32px 0 12px;" data-i18n="rgpd.h5">5. Vos droits</h2>
        ...
        <h2 style="font-family:'Bebas Neue',sans-serif; font-size:1.8rem; margin:32px 0 12px;" data-i18n="rgpd.h6">6. Sous-traitants</h2>
