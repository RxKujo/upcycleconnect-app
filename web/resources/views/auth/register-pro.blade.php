...
<body>
    ...
    <div class="auth-container">
        ...
        <div class="auth-card">
            ...
            <form id="registerProForm" method="POST" action="http://localhost:8888/api/v1/auth/register-professionnel" novalidate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        <label for="adresse_complete" class="form-label">Adresse entreprise (optionnel)</label>
                        <input
                            type="text"
                            id="adresse_complete"
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            const requiredFields = ['nom', 'prenom', 'email', 'nom_entreprise', 'numero_siret', 'ville', 'mot_de_passe', 'password_confirmation'];
