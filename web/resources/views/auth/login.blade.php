    ...
    <script>
        ...
        if (passwordToggle) {
            passwordToggle.addEventListener('click', (e) => {
                ...
                passwordToggle.innerHTML = `<span class="toggle-icon">${isPassword ? eyeSlashIcon : eyeIcon}</span>`;
            });
        }
        ...
        const showAlert = (message, type = 'error', details = null) => {
            ...
            const icons = {
                ...
                warning: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16"><path d="M5.52.359A.5.5 0 0 1 6 0h4a.5.5 0 0 1 .474.658L8.694 6H12.5a.5.5 0 0 1 .395.807l-7 9a.5.5 0 0 1-.873-.454L6.823 9.5H3.5a.5.5 0 0 1-.48-.641z"/></svg>`,
