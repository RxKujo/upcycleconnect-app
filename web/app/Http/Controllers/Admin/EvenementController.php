...
class EvenementController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::withToken(session('admin_token'))
            ->post('http://api:8888/api/v1/admin/evenements', $payload);
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withToken(session('admin_token'))
            ->put("http://api:8888/api/v1/admin/evenements/{$id}", $payload);
    ...
    public function destroy($id)
    {
        Http::withToken(session('admin_token'))
            ->delete("http://api:8888/api/v1/admin/evenements/{$id}");
    ...
    {
        Http::withToken(session('admin_token'))
            ->put("http://api:8888/api/v1/admin/evenements/{$id}/attente");
