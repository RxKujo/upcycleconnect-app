...
class CategorieController extends Controller
{
    public function index()
    {
        $response = Http::withToken(session('admin_token'))
            ->get('http://api:8888/api/v1/admin/categories');
    ...
    public function store(Request $request)
    {
        ...
        $response = Http::withToken(session('admin_token'))
            ->post('http://api:8888/api/v1/admin/categories', [
                'nom' => $request->nom,
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withToken(session('admin_token'))
            ->put("http://api:8888/api/v1/admin/categories/{$id}", [
                'nom' => $request->nom,
                'description' => $request->description,
            ]);
    ...
    {
        $response = Http::withToken(session('admin_token'))
            ->delete("http://api:8888/api/v1/admin/categories/{$id}");
