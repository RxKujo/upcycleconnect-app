...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — UpcycleConnect</title>
    ...
    <div class="admin-wrapper">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <a href="<?php echo e(route('admin.utilisateurs.index')); ?>" class="<?php echo e(request()->is('admin/utilisateurs*') ? 'active' : ''); ?>">
                    <span style="margin-right: 12px; font-size: 1.2em;">◆</span> Utilisateurs
                </a>
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="<?php echo e(request()->is('admin/categories*') ? 'active' : ''); ?>">
                    <span style="margin-right: 12px; font-size: 1.2em;">◆</span> Catégories
                </a>
                <a href="<?php echo e(route('admin.prestations.index')); ?>" class="<?php echo e(request()->is('admin/prestations*') ? 'active' : ''); ?>">
                    <span style="margin-right: 12px; font-size: 1.2em;">◆</span> Prestations
                </a>
                <a href="<?php echo e(route('admin.evenements.index')); ?>" class="<?php echo e(request()->is('admin/evenements*') ? 'active' : ''); ?>">
                    <span style="margin-right: 12px; font-size: 1.2em;">◆</span> Événements
                </a>
                <a href="<?php echo e(route('admin.conteneurs.index')); ?>" class="<?php echo e(request()->is('admin/conteneurs*') ? 'active' : ''); ?>">
            ...
            <div class="content-container">
                <?php if(session('success')): ?>
                    <div class="alert alert-success">
                        <span style="font-size: 1.4rem;">✓</span> <?php echo e(session('success')); ?>

                    </div>
                <?php endif; ?>
                <?php if(session('error')): ?>
                    <div class="alert alert-error">
                        <span style="font-size: 1.4rem;">⚠</span> <?php echo e(session('error')); ?>
...
<?php /**PATH C:\Users\klint\Documents\cours\projet annuel\Année 2\UpcycleConnect_PA\upcycleconnect-app\web\resources\views/layouts/admin.blade.php ENDPATH**/ ?>